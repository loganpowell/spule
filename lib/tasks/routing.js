    ...
    return function (acc) {
        ...
        return __spread(preroute, [
            (_a = {},
                ...
                _a),
            (_b = {}, _b[keys_js_1.CMD_ARGS] = prefix ? utils_1.parse(acc[keys_js_1.URL_FULL], prefix) : utils_1.parse(acc[keys_js_1.URL_FULL]), _b),
            __assign(__assign({}, SET_STATE), (_c = {}, _c[keys_js_1.CMD_ARGS] = function (_acc) {
                var _a;
                return (_a = {},
                    _a[keys_js_1.STATE_DATA] = _acc[keys_js_1.URL_PATH],
                    _a[keys_js_1.STATE_PATH] = [keys_js_1.ROUTE_PATH],
                    _a);
            }, _c))
        ], postroute);
    };
    ...
    return function (acc) {
        ...
        return [
            __assign(__assign({}, SET_STATE), (_a = {}, _a[keys_js_1.CMD_ARGS] = (_b = {},
                _b[keys_js_1.STATE_PATH] = [keys_js_1.ROUTE_LOAD],
            ...
            __assign(__assign({}, SET_STATE), (_e = {}, _e[keys_js_1.CMD_ARGS] = function (_acc) {
                var _a;
                return (_a = {},
                    _a[keys_js_1.STATE_PATH] = [keys_js_1.ROUTE_VIEW],
            ...
            __assign(__assign({}, SET_STATE), (_g = {}, _g[keys_js_1.CMD_ARGS] = function (_) {
                var _a;
                return (_a = {},
                    _a[keys_js_1.STATE_PATH] = [keys_js_1.ROUTE_LOAD],
