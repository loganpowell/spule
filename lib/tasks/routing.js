...
exports.__URL__ROUTE = function (CFG) {
 ...
 * - `URL_data`
 */
exports.__URL_DOM__ROUTE = function (CFG) {
    // autoscroll view into position
    // scrolly.start()
    // instantiate router
    var match = exports.__URL__ROUTE(CFG);
    return function (acc) {
        ...
        return [
            __assign(__assign({}, SET_STATE), (_a = {}, _a[keys_js_1.args_] = (_b = {},
                ...
                _b), _a)),
            __assign(__assign({}, commands_1.__HREF_PUSHSTATE_DOM), (_c = {}, _c[keys_js_1.args_] = (_d = {}, _d[keys_js_1.URL_] = acc[keys_js_1.URL_], _d[keys_js_1.DOM_] = acc[keys_js_1.DOM_], _d), _c)),
            ...
            // { sub$: log$, args: () => ({ DOM }) },
            commands_1.__SET_LINK_ATTRS_DOM,
            ...
            commands_1.__NOTIFY_PRERENDER_DOM
        ];
    };
};
