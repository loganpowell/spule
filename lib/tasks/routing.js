...
exports.URL__ROUTE = CFG => {
    ...
    return acc => [
         ...
         */
        {
            ...
            [keys_js_1.CMD_ERRO]: (_acc, _err) => console.warn("Error in URL__ROUTE:", _err, "constructed:", _acc)
        },
...
exports.URL_DOM__ROUTE = CFG => {
    ...
    return acc => [
        ...
        {
            ...commands_1.HREF_PUSHSTATE_DOM,
            [keys_js_1.CMD_ARGS]: { [keys_js_1.URL_FULL]: acc[keys_js_1.URL_FULL], [keys_js_1.DOM_NODE]: acc[keys_js_1.DOM_NODE] }
        },
