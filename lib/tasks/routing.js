...
exports.URL__ROUTE = function (CFG) {
    ...
    return function (acc) {
        ...
        return __spread(preroute, [
            (_a = {},
                _a[keys_1.CMD_ARGS] = prefix
                    ? router(acc[keys_1.URL_FULL].replace(prefix, ""))
                    : router(acc[keys_1.URL_FULL]),
                ...
                _a[keys_1.CMD_ERRO] = function (_acc, _err) {
            ...
            (_b = {},
                ...
                _b),
            __assign(__assign({}, SET_STATE), (_c = {}, _c[keys_1.CMD_ARGS] = function (_acc) {
                var _a;
                return (_a = {},
...
exports.URL_DOM__ROUTE = function (CFG) {
    ...
    return function (acc) {
        ...
        return [
            __assign(__assign({}, SET_STATE), (_a = {}, _a[keys_1.CMD_ARGS] = (_b = {},
            ...
            __assign(__assign({}, SET_STATE), (_e = {}, _e[keys_1.CMD_ARGS] = function (_acc) {
                var _a;
                return (_a = {},
            ...
            __assign(__assign({}, SET_STATE), (_f = {}, _f[keys_1.CMD_ARGS] = function (_acc) {
                var _a;
                return (_a = {},
            ...
            __assign(__assign({}, SET_STATE), (_g = {}, _g[keys_1.CMD_ARGS] = function (_) {
                var _a;
                return (_a = {},
