...
exports.stringify_w_functions = (x, indent) => JSON.stringify(x, (key, value) => {
...
exports.key_index_err = (c, i) => {
    const idx_dict0 = Array.from(Array(19).keys()).reduce((a, idx) => ({ ...a, [idx]: `${idx + 1}th` }), {});
