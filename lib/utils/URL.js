...
exports.fURL = (_URL, prefixRGX) => {
    ...
    const URL_query = querystring_1.default.parse(query_str.slice(1));
    // remove the actual `#` hash character from the string
    const URL_hash = hash_str.slice(1);
    return {
        [keys_js_1.URL_]: _URL,
        [keys_js_1.URL_subdomain_]: URL_subdomain,
        [keys_js_1.URL_domain_]: URL_domain,
        [keys_js_1.URL_path_]: URL_path,
        [keys_js_1.URL_query_]: URL_query,
        [keys_js_1.URL_hash_]: URL_hash
    };
};
/**
 *
...
exports.unfURL = (parsed, isAbsolute = false) => {
    ...
    const { [keys_js_1.URL_subdomain_]: URL_subdomain, [keys_js_1.URL_domain_]: URL_domain, [keys_js_1.URL_path_]: URL_path, [keys_js_1.URL_query_]: URL_query, [keys_js_1.URL_hash_]: URL_hash } = exports.fURL(parsed[keys_js_1.URL_] || window.location.href);
    ...
    const [protocol, rest] = keys_js_1.URL_.split("//");
    ...
    const query_string = querystring_1.default.encode(_URL_query);
