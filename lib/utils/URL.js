...
exports.unparse = function (parsed, isAbsolute) {
    ...
    var _a = exports.parse(parsed[keys_1.URL_FULL] || window.location.href), _b = keys_1.URL_SUBD, URL_subdomain = _a[_b], _c = keys_1.URL_DOMN, URL_domain = _a[_c], _d = keys_1.URL_PATH, URL_path = _a[_d], _e = keys_1.URL_QERY, URL_query = _a[_e], _f = keys_1.URL_HASH, URL_hash = _a[_f];
    ...
    var _m = __read(keys_1.URL_FULL.split("//"), 2), protocol = _m[0], rest = _m[1];
