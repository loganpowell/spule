 ...
 *
 * */
exports.fURL = function (_URL, prefixRGX) {
    var _a;
    // console.log("parsing...")
    var URL_subdomain = [];
    var URL_domain = [];
    ...
    return _a = {},
        _a[keys_js_1.URL_] = _URL,
        _a[keys_js_1.URL_subdomain_] = URL_subdomain,
        _a[keys_js_1.URL_domain_] = URL_domain,
        _a[keys_js_1.URL_path_] = URL_path,
        _a[keys_js_1.URL_query_] = URL_query,
        _a[keys_js_1.URL_hash_] = URL_hash,
        _a;
};
/**
 *
 ...
 *
 */
exports.unfURL = function (parsed, isAbsolute) {
    // console.log("unparsing...")
    if (isAbsolute === void 0) { isAbsolute = false; }
    var _a = exports.fURL(parsed[keys_js_1.URL_] || window.location.href), _b = keys_js_1.URL_subdomain_, URL_subdomain = _a[_b], _c = keys_js_1.URL_domain_, URL_domain = _a[_c], _d = keys_js_1.URL_path_, URL_path = _a[_d], _e = keys_js_1.URL_query_, URL_query = _a[_e], _f = keys_js_1.URL_hash_, URL_hash = _a[_f];
    ...
    var _m = __read(keys_js_1.URL_.split("//"), 2), protocol = _m[0], rest = _m[1];
