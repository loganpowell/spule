...
exports.multiplex = task_array => task_array.reduce((a, c, i) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (checks_1.isFunction(c)) {
        try {
            ...
            // stacks
            recur.unshift({ [keys_js_1.args_]: acc });
    ...
    const sub$ = c[keys_js_1.sub$_];
    const args = c[keys_js_1.args_];
    const erro = c[keys_js_1.erro_];
    const reso = c[keys_js_1.reso_];
    ...
    if (result !== Object(result)) {
        ...
        stream__js_1.command$.next({ [keys_js_1.sub$_]: sub$, [keys_js_1.args_]: result });
        return acc;
    }
