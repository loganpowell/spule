...
//   })
// }
var pre = function (ctx, body) { return (console.log("no `app` component provided to `" + exports.boot.name + "({" + keys_js_1.CFG_VIEW + "})`. Rendering state by route path"),
...
exports.boot = function (CFG) {
    ...
    var escRGX = /[-/\\^$*+?.()|[\]{}]/g;
    var escaped = function (string) { return string.replace(escRGX, "\\$&"); };
