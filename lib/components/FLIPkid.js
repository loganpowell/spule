...
exports.FLIPkid = Object.freeze({
        ...
        return __spread([
            "div",
            {
                onclick: function (ev) {
                    ...
                    ctx[keys_1.CFG_RUN$]([
                        __assign(__assign({}, commands_1.HURL), (_a = {}, _a[keys_1.CMD_ARGS] = sim_event(href), _a)),
                        __assign(__assign({}, commands_1.FLIP_FIRST), (_b = {}, _b[keys_1.CMD_ARGS] = { id: href, target: target }, _b))
                    ]);
                }
            }
        ], rest);
    ...
    init: function (el, ctx) {
        ...
        // }),
        ctx[keys_1.CFG_RUN$](__assign(__assign({}, commands_1.FLIP_LAST_INVERSE_PLAY), (_a = {}, _a[keys_1.CMD_ARGS] = {
