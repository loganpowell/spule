...
exports.FLIP_FIRST = register_js_1.registerCMD({
    [keys_js_1.sub$_]: "FLIP_FIRST",
    [keys_js_1.args_]: x => x,
    [keys_js_1.handler_]: ({ id, target }) => FLIPFirst({ id, target, state })
});
exports.FLIP_LAST_INVERSE_PLAY = register_js_1.registerCMD({
    [keys_js_1.sub$_]: "FLIP_LAST_INVERSE_PLAY",
    [keys_js_1.args_]: x => x,
    [keys_js_1.handler_]: ({ id, element }) => FLIPLastInvertPlay({ id, element, state })
});
