...
exports.INJECT_HEAD = register_js_1.registerCMD((_a = {},
    // source$: DOMnavigated$,
    _a[keys_js_1.sub$_] = "INJECT_HEAD",
    _a[keys_js_1.args_] = function (acc) {
        var _a;
        return (_a = {}, _a[keys_js_1.URL_data_] = acc[keys_js_1.URL_data_], _a);
    },
    _a[keys_js_1.handler_] = function (_a) {
        var _b = keys_js_1.URL_data_, _c = keys_js_1.HEAD_, _d = _a[_b][_c], title = _d.title, description = _d.description, image = _d.image, favicon = _d.favicon, type = _d.type;
